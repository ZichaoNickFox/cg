...
class LinesMesh : public Mesh {
 public:
  ...
  LinesMesh(const std::vector<glm::vec3>& positions, const std::vector<glm::vec4>& colors,
            rhi::PrimitiveTopology primitive_mode);
  LinesMesh(const std::vector<glm::vec4>& positions, const std::vector<glm::vec4>& colors,
            rhi::PrimitiveTopology primitive_mode);
};
